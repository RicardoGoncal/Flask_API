...
class TokenRefresh(MethodView):
    ...
    def post(self):
        ...
        # Deixe claro que quando adicionar o token de atualização à lista de bloqueio dependerá do design do aplicativo
        jti = get_jwt()["jti"]
        BLOCKLIST.add(jti)
        return {"access_token": new_token}, 200

"""
O recurso abaixo só é viavel para testes
Não queremos expor usuario publico
Mas para os testes é bem legal para uma demonstração
"""
